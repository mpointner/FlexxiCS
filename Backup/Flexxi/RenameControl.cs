...
namespace ImageFrame
{
    public partial class RenameControl : UserControl
    {
        ...
        public string run(string path, Image image)
        {
            ...
            string zeros = "0";
            if (DateLeadingZeros.Text == "Yes")
            {
                zeros = "00";
            }

            long size = new FileInfo(path).Length / 1000;
            ...
            filter = filter.Replace("[Size]", size.ToString() + "KB");
            i++;
